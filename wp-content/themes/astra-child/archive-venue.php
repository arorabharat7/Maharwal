    ...
    <div class="container m-auto">
        ...
        <div class="grid grid-cols-12 lg:mt-16 md:mt-12 mt-10 bg-white rounded-[20px] items-center">
            ...
            <div class="lg:col-span-6 col-span-12 lg:order-2 order-1">
                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/maharwal_venues-one.webp" alt="venues" class="w-full lg:rounded-tr-[20px] lg:rounded-br-[20px] lg:rounded-tl-[0px] rounded-tl-[20px] rounded-tr-[20px]">
            </div>
