...
?>
	...
	if ( have_comments() ) :
		...
		?>
			<<?php echo esc_attr( $title_tag ); ?> class="comments-title text-[32px] text-primary bagdoll-display">
				<?php
				$astra_comments_title = apply_filters(
					'astra_comment_form_title',
					sprintf( // WPCS: XSS OK.
						/* translators: 1: number of comments */
						esc_html( _nx( '%1$s Comments','%1$s Comments' ,get_comments_number(),'comments title', 'astra' ) ),
