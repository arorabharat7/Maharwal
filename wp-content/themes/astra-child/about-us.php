...
<?php
$about_us_connect_us_section_bg_image = get_field('about_us_connect_us_section_bg_image');
$about_us_connect_us_section_heading = get_field('about_us_connect_us_section_heading');
$about_us_connect_us_section_btn_url = get_field('about_us_connect_us_section_btn_url');
...
<section class="connect-us bg-no-repeat bg-cover lg:pt-100 md:pt-60 pt-10 lg:pb-[200px] md:pb-36 pb-16" style="background-image: url(<?php echo $about_us_connect_us_section_bg_image['url']; ?>);">
  ...
  <div class="text-center">
    ...
    <a href="<?php echo $about_us_connect_us_section_btn_url; ?>" class="btn text-sm font-semibold hover:text-primary hover:bg-white transition text-light-black bg-secondary px-7 md:py-5 py-4 rounded-large inline-block uppercase">
      <?php echo $about_us_connect_us_section_btn_text; ?> <i class="fa-solid fa-arrow-right ml-2"></i></a>
  </div>
